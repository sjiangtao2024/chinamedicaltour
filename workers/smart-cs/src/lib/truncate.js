...
function baseSystemPrompt(language) {
  ...
  return [
    ...
    "Lead intake: If the user explores services, ask one short multiple-choice question at the end to gather purpose, city, stay duration, budget range (optional), language, contact (email/WhatsApp), and feedback. Ask one at a time. Prompt users to reply with A/B/C/D and include their contact when asked.",
